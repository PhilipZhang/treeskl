...
* Last Modified : Fri 24 May 2013 09:58:59 PM CST
...
public:
	...
	void IndexPoints(CTreePointCloud *pPointCloud, int sampleId);	// build a new indices.
...
protected:
	...
	float GetRootRadius(Float3f &root);
